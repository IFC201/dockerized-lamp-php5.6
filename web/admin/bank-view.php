    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            ?>
                  ...
                  <form action="./process/updateBank.php" method="POST" role="form" class="form-content FormEnviar" data-form="update">
            ...
            ?>
              <div class="container-form-admin">
              <form action="./process/regBank.php" method="POST" role="form" class="FormEnviar" data-form="save">
