                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="text-center"><textarea readonly><?php echo $order['NumeroDeposito']; ?></textarea></td>
                            <td class="text-center"><?php echo $order['Fecha']; ?></td>
                            <td class="text-center"><?php echo $order['Descuento']; ?>%</td>
                            ...
                            <td class="text-center">
                              <form action="process/delPedido.php" method="POST" class="FormEnviar" data-form="delete">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-order" aria-hidden="true">
  <div class="modal-dialog modal-sm">
      <div class="modal-content" style="padding: 15px;">
        ...
        <form action="./process/updatePedido.php" method="POST" class="FormEnviar" data-form="update">
