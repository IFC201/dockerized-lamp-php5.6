<!-- Pequeño espaciado entre configAdmin(el menú) y product-view / -->
<p class="lead">
</p>

<!-- Nuevo producto & Productos en tienda -->
<ul class="breadcrumb"">
  <li>
  ...
  <!-- Capa 2 -->
    ...
    <div class="col-xs-12">
      ...
      <div class="container-form-admin">
        ...
        <!-- Capa 1: Formulario -->
        <form action="./process/regproduct.php" method="POST" enctype="multipart/form-data" class="FormEnviar" data-form="save">
          <!-- Capa 2 -->
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                <div class="form-group">
                  <input type="file" name="img">  <!-- campo input de la imagen(name) -->
          ...
          <!-- Input oculto con el nombre del admin -->
