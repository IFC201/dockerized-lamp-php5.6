<!-- configAdmin es el Panel de administración -->
<?php
	// Definir (USER, SERVER, BD, PASS) para la conexión
...
<body id="container-page-configAdmin">
    ...
    <section id="prove-product-cat-config" class="contenedor-flex">
        <div class="container">
          <div class="page-header">
            <h1>Panel de administración <small class="tittles-pages-logo">FLORART</small></h1>
          </div>
          <!--====  Nav Tabs  ====-->
